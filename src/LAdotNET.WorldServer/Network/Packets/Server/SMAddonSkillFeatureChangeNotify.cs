...
{
    class SMAddonSkillFeatureChangeNotify : Packet
    {
        public SMAddonSkillFeatureChangeNotify(Connection connection) : base(connection)
        {
        ...
        public override void Deserialize()
        {
            Data.WriteBytes(new byte[]
            {
                ...
                0xAC, 0x77, 0x04, 0x2B, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
            });
        }
