...
{
    class SMInitSail : Packet
    {
        public SMInitSail(Connection connection) : base(connection)
        {
        ...
        public override void Deserialize()
        {
            ...
            {
                0x0A, 0x00, 0x01, 0x00, 0x00, 0x00, 0x02, 0x00, 0x00, 0x00, 0x03, 0x00, 0x00, 0x00, 0x04, 0x00,
                0x00, 0x00, 0x05, 0x00, 0x00, 0x00, 0x06, 0x00, 0x00, 0x00, 0x07, 0x00, 0x00, 0x00, 0x08, 0x00,
                0x00, 0x00, 0x0A, 0x04, 0x00, 0x00, 0x0B, 0x04, 0x00, 0x00
            });
        }
