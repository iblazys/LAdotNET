...
{
    class SMBattleSlotUpdateNotify : Packet
    {
        public SMBattleSlotUpdateNotify(Connection connection) : base(connection)
        {
        ...
        public override void Deserialize()
        {
            Data.WriteBytes(new byte[]
            {
                ...
                0x00, 0x00, 0x00, 0x00, 0x02, 0x00, 0x00, 0x00, 0x00, 0x00, 0xFF, 0xFF, 0xFF, 0xFF
            });
        }
